...
class NeuralNetworkModel():
    ...
    def backward(self, target, out):
        ...
        dY_hat = self.loss.backward(target, out) # gradient of loss w.r.t Y_hat
    ...
    def predict(self, X, Y):
        ...
        # Do a forward pass to get the predictions.
        pred = self.forward(X) 
        # Get the loss. Remember that the `backward` function returns the loss.
        loss = self.backward(Y, pred)

        return pred, loss # return a tuple of the prediction and loss
